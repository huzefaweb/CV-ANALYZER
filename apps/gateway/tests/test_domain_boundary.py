"""AC#4: automated check that the pure domain kernel stays framework-free.

Fails if any module under src/domain imports a web framework, database
driver, filesystem implementation, identity SDK, parser SDK, provider SDK,
or a concrete clock (datetime.now/date.today) instead of an injected one.
"""
